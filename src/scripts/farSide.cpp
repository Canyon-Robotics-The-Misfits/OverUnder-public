...
void farSide(AUTO_PARAMETERS)
{
    ...
    drive_controller->setThreshold(5);
    drive_controller->boomerang(pos(120, 120), 270 - 45, true);
    drive_controller->faceAngle(270 + 45);
    intake->move(-127);
    frontRightWing->extend();
    ...
    pros::delay(400);
    intake->move(127);
    drive_controller->setThreshold(9);
    drive_controller->boomerang(pos(144 - 48, 72), INFINITY, false, 0.8);
    drive_controller->faceAngle(270 + 10);

    frontLeftWing->extend();
    frontRightWing->extend();
    drive_controller->setMaxSpeed(110);
    drive_controller->boomerang(pos(72, 120), 0, false, 0.6);
}