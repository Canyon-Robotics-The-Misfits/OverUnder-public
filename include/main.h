 ...
 * 
 * @return std::shared_ptr<lib15442c::IDrivetrain> The drivetrain
 */
std::shared_ptr<lib15442c::IDrivetrain> create_drivetrain();
/**
 * @brief Create a tracking wheel odometry object
 * 
 * @return std::shared_ptr<lib15442c::TrackerOdom> The odometry
*/
